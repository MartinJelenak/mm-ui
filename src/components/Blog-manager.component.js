                        ...
                        {data.data.map((row, index) => (
                            ...
                            <tr key={index} className={(() => {
                                ...
                                <td style={{ textAlign: "right" }}>
                                    <button onClick={() => deleteClickHandle(row)} type="button" className="btn btn-default" aria-label="Left Align">
                                    ...
                                    {(() => {
                                        switch (row.confirmation.length) {
                                            case 2: return <></>;
                                            default: return <button onClick={() => confirmClickHandle(row)} type="button" className="btn btn-default" aria-label="Left Align">
